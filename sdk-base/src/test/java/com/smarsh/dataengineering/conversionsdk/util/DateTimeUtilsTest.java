...
import com.smarsh.dataengineering.conversionsdk.util.DateTimeUtils.InvalidDateException;
...
class DateTimeUtilsTest {
    ...
    void epochMillisToXmlGregorian(long epochMillis, XMLGregorianCalendar calendar) throws InvalidDateException, DatatypeConfigurationException {
    ...
    @Test
    void dateStringToEpochMillis() throws InvalidDateException  {
        ...
        assertThrows(InvalidDateException.class, () -> DateTimeUtils.toEpochMillis(null, format));
        assertThrows(InvalidDateException.class, () -> DateTimeUtils.toEpochMillis(dateString, (DateTimeFormatter) null));
        assertThrows(InvalidDateException.class, () -> DateTimeUtils.toEpochMillis("hello, world", format));
    }

    @Test
    void dateStringToEpochMillisMultiple() throws InvalidDateException {
        var dateString = "2022-01-02T03:04:05.678Z";
        var formats = List.of(
        ...
        assertThrows(InvalidDateException.class, () -> DateTimeUtils.toEpochMillis("", formats));
    }
    ...
    @Test
    void toEpochMillisStringMultipleFormatsDefault() throws Exception {
        var dateString = "2022-01-02T03:04:05.678Z";
        var formats = List.of(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSX"));
        var expected = 1641092645678L;

        assertEquals(expected, DateTimeUtils.toEpochMillis(dateString, formats, 0L));
        assertDoesNotThrow(() -> DateTimeUtils.toEpochMillis("", formats, 0L));
        assertEquals(0L, DateTimeUtils.toEpochMillis("", formats, 0L));
        assertEquals(expected, DateTimeUtils.toEpochMillis("", formats, expected));
    }
